class DescriptionController < ApplicationController
  def new_generated
    ...
    render :json => {id: description.id, start_time_sec: params[:time].to_f, generated: true, url: description.generate_tts ? description.get_download_url_for_audio_file : "", inline_extended: description.pause_at_start_time ? "extended" : "inline"}.to_json
  end
...
# unable to implement asking for browser microphone permissions
  def new_recorded
    ...
    if params[:audio_content]!=nil
      ...
      render :json => {id: description.id, start_time_sec: params[:time].to_f, generated: false, url: description.audio_file_loc ? description.get_download_url_for_audio_file : "", inline_extended: description.pause_at_start_time ? "extended" : "inline"}.to_json
    end
  end
