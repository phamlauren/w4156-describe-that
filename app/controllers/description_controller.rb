class DescriptionController < ApplicationController
  def new_generated
    ...
    @description = Description.create(pause_at_start_time: params[:pause_at_start_time]=="1" ? true : false, desc_type: 'generated', audio_file_loc: "", desc_text: params[:description], voice_id: 2, voice_speed: params[:voice_speed].to_f, desc_track_id: params[:track_id].to_i, start_time_sec: params[:time])
