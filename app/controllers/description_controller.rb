class DescriptionController < ApplicationController
  def new_generated
    ...
    description = Description.create(
      pause_at_start_time: params[:pause_at_start_time]=="1" ? true : false,
      desc_type: 'generated', audio_file_loc: "",
      desc_text: params[:description],
      voice_id: params[:voice_id].to_i,
      voice_speed: params[:voice_speed].to_f,
      desc_track_id: params[:track_id].to_i,
      start_time_sec: params[:time].to_f,
      video_volume_inline: params[:pause_at_start_time]=="1" ? nil : params[:video_vol_inline].to_f
    )
    ...
    render :json => {
      ...
      start_time_sec: params[:time].to_f,
      generated: true,
      url: description.generate_tts ? description.get_download_url_for_audio_file : "",
      inline_extended: description.pause_at_start_time ? "extended" : "inline",
      video_vol_inline: description.video_volume_inline.nil? ? 100 : description.video_volume_inline
    }.to_json
  end
  ...
  def edit_generated
    ...
    editable = {
      ...
      pause_at_start_time: d.pause_at_start_time ? "1" : "0",
  ...
  def new_recorded
    ...
    if params[:audio_content]!=nil
      ...
      description = Description.create(
        pause_at_start_time: params[:pause_at_start_time]=="1" ? true : false,
        desc_type: 'recorded',
        audio_file_loc: this_description_filename,
        desc_track_id: params[:track_id].to_i,
        start_time_sec: params[:time].to_f,
        video_volume_inline: params[:pause_at_start_time]=="1" ? nil : params[:video_vol_inline].to_f
      )
      ...
      render :json => {
        ...
        start_time_sec: params[:time].to_f,
        generated: false,
        url: description.audio_file_loc ? description.get_download_url_for_audio_file : "",
        inline_extended: description.pause_at_start_time ? "extended" : "inline",
        video_vol_inline: description.video_volume_inline.nil? ? 100 : description.video_volume_inline
      }.to_json
    end
